...
This adapter can be used to adapt Hibernate 4 naming strategies to Hibernate 5 `ImplicitNamingStrategy`. [ImprovedNamingStrategy for Hibernate 5](https://github.com/v-ladynev/fluent-hibernate#improvednamingstrategy-for-hibernate-5) is builded on top of it. So it has the same limitations.
